                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" className="text-dark text-center">Tên Khách Hàng</th>
                        <th scope="col" className="text-dark text-center">Số Điện Thoại</th>
                        <th scope="col" className="text-dark text-center">Dịch Vụ</th>
                        <th scope="col" className="text-dark text-center">Avatar</th>
                        <th scope="col" className="text-dark text-center">Thời gian</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
